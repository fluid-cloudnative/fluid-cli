## fluid diagnose config unset llm-endpoint

Remove the configured LLM API endpoint

```
fluid diagnose config unset llm-endpoint [flags]
```

### Options

```
  -h, --help   help for llm-endpoint
```
