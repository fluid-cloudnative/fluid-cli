...
Collect diagnostic data for a Fluid Dataset and its Runtime(s)

### Synopsis

Diagnose collects diagnostic data for a given Fluid Dataset, including:
...
```
fluid diagnose <dataset-name> [flags]
```

### Examples

```
  # Diagnose a Dataset in the current namespace
